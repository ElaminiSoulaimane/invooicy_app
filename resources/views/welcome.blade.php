    ...
    <style>
        ...
        *,
        ...
        @media (prefers-color-scheme: dark) {
            ...
            .dark\:bg-red-800\/20 {
                background-color: rgba(156, 255, 30, 0.2)
            }
...
<body class="antialiased">
    <div
        class="relative sm:flex sm:justify-center sm:items-center min-h-screen  bg-center bg-perf-black dark:bg-dots-lighter dark: bg-perf-black  selection:bg-red-500 selection:text-white">
        @if (Route::has('login'))
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                ...
                <img style="height: 150px" src="{{ asset('images/Logo_Complete.png') }}" alt="Logo">
            ...
            <div class="">
                ...
                <a class="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"
                    href="{{ route('language.switch', 'fr') }}">Français</a>
                <a class="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"
